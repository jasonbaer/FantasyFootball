...
def perform_session_download(year, position, week, scoring, json_path):
	...
	json_path = '/Users/jasonbaer/Documents/My Documents/R/FantasyFootball/fftiers/test_rb.json'
	"""
	api_key = getAPIKey()
...
def make_path():
	try:
		os.system('mkdir -p /Users/jasonbaer/Documents/My Documents/R/FantasyFootball/fftiers/dat/2018/')
	except:
		pass
